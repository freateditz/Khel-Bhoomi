      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Everything you need to excel in sports, connect with like-minded
            individuals, and showcase your talent to the world.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Create comprehensive profiles with achievements, stats, and
                    videos
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Track your progress, set goals, and monitor improvements
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Get discovered by professional scouts and recruiters
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Access comprehensive database of athletes with detailed
                    profiles
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Search by sport, location, age, skill level, and
                    achievements
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Connect directly with athletes and their representatives
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="glass-card border-0 shadow-xl">
            <CardHeader>
              ...
              <CardDescription>
                Follow and support your favorite athletes
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Stay updated with your favorite athletes' journeys and
                    achievements
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Engage in sports discussions and celebrate victories
                    together
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Get real-time updates on matches, tournaments, and events
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          {[
            {
              ...
              desc: "Instant messaging between athletes and scouts",
            },
            {
              icon: <Camera className="h-8 w-8" />,
              title: "Media Upload",
              desc: "Share photos and videos of your achievements",
            },
            {
              icon: <Bell className="h-8 w-8" />,
              title: "Smart Notifications",
              desc: "Never miss important updates or opportunities",
            },
            {
            ...
            <Card
              key={index}
              className="glass-card border-0 shadow-lg text-center"
            >
      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
            We're on a mission to revolutionize Indian sports by connecting
            talented athletes with professional scouts and passionate fans,
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <Card className="glass-card border-0 shadow-xl">
            <CardContent className="p-8">
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                To democratize sports opportunities in India by providing a
                platform where talent is recognized regardless of background,
                location, or connections. We believe every athlete deserves a
                chance to shine.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="glass-card border-0 shadow-xl">
            <CardContent className="p-8">
              ...
              <p className="text-slate-600 text-lg leading-relaxed">
                To become India's premier sports discovery platform, where the
                next Olympic champion, cricket star, or sporting legend is
                discovered and nurtured through our community-driven ecosystem.
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="glass-card border-0 shadow-xl">
            <CardContent className="p-12">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-slate-600">
                  From idea to India's sports revolution
                </p>
              </div>

              <div className="max-w-4xl mx-auto">
                <p className="text-slate-700 text-lg leading-relaxed mb-6">
                  Khel Bhoomi was born from a simple observation: India has
                  incredible sporting talent, but many athletes struggle to get
                  the recognition and opportunities they deserve. Traditional
                  scouting methods often miss gems hidden in small towns and
                  rural areas.
                </p>
                <p className="text-slate-700 text-lg leading-relaxed mb-6">
                  Founded in 2025, our platform leverages technology to bridge
                  this gap. We've created a space where athletes can showcase
                  their abilities, scouts can discover new talent efficiently,
                  and fans can support the sports ecosystem at every level.
                </p>
                <p className="text-slate-700 text-lg leading-relaxed">
                  Today, we're proud to be home to over 10,000 athletes, 500+
                  professional scouts, and 50,000+ passionate sports fans, all
                  working together to elevate Indian sports to new heights.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="glass-card border-0 shadow-lg text-center">
              <CardContent className="p-8">
                ...
                <p className="text-slate-600">
                  Sports excellence knows no boundaries. We welcome athletes
                  from all backgrounds, regions, and skill levels.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card border-0 shadow-lg text-center">
              <CardContent className="p-8">
                ...
                <p className="text-slate-600">
                  ...
                  platform features to the opportunities we create.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-card border-0 shadow-lg text-center">
              <CardContent className="p-8">
                ...
                <p className="text-slate-600">
                  Sports are best when shared. We foster a supportive community
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
            Whether you're an athlete with dreams, a scout seeking talent, or a
            fan who loves sports, you have a place in our community.
          </p>
          <Button
            size="lg"
...
const UserProfilePage = () => {
  ...
  const toggleFollow = () => {
    ...
    toast({
      ...
      description: `You are ${
        following ? "no longer following" : "now following"
      } ${profileUser?.full_name || username}`,
    });
  };
          ...
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  <div>
                    ...
                    <div className="flex items-center space-x-3 mb-3">
                      <Badge
                        className={`border ${getRoleColor(profileUser.role)}`}
                      >
                ...
                {/* Sports Interests */}
                {profileUser.sports_interests &&
                  profileUser.sports_interests.length > 0 && (
                    <div className="mt-4">
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-1">
                            ...
                            <Badge
                              className={`text-xs px-2 py-1 border ${getRoleColor(
                                profileUser.role
                              )}`}
                            >
                              <span className="flex items-center space-x-1">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {post.sports_tags.map((tag, index) => (
                            <Badge
                              key={index}
                              variant="secondary"
                              className="text-xs bg-purple-100 text-purple-600 hover:bg-purple-200 cursor-pointer"
                            >
                              #{tag}
                            </Badge>
                          ))}
              ...
              <div className="flex items-start space-x-3">
                <div className="relative">
                  <Avatar className="w-12 h-12">
                    <AvatarFallback
                      className={`${
                        conversation.role === "scout"
                          ? "bg-green-100 text-green-600"
                          : conversation.role === "fan"
            ...
            <div className="p-6 bg-white/80 backdrop-blur-xl border-b border-purple-100">
              <div className="flex items-center space-x-4">
                <Avatar className="w-12 h-12">
                  <AvatarFallback
                    className={`${
                      selectedChat.role === "scout"
                        ? "bg-green-100 text-green-600"
                        : selectedChat.role === "fan"
                        ? "bg-purple-100 text-purple-600"
                        : "bg-blue-100 text-blue-600"
                    } font-semibold`}
                  >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center space-x-2 bg-purple-100/50 backdrop-blur-sm px-4 py-2 rounded-full mb-8">
                ...
                <span className="text-purple-700 font-medium text-sm">
                  India's Premier Sports Social Platform
                </span>
              </div>
              ...
              <p className="text-2xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
                Where athletes shine, scouts discover champions, and fans
                celebrate the spirit of sports. Join India's most vibrant sports
                community today.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
              <Card className="glass-card group hover:scale-105 transition-all duration-500 border-0 shadow-2xl overflow-hidden relative">
                ...
                <CardContent className="text-center relative z-10">
                  <p className="text-slate-600 mb-6 leading-relaxed">
                    Build your sports profile, share achievements, connect with
                    scouts, and get discovered by teams looking for talent like
                    yours.
                  </p>
              ...
              <Card className="glass-card group hover:scale-105 transition-all duration-500 border-0 shadow-2xl overflow-hidden relative">
                ...
                <CardContent className="text-center relative z-10">
                  <p className="text-slate-600 mb-6 leading-relaxed">
                    Find the next sports stars, evaluate player performance,
                    build winning teams, and connect with emerging talent across
                    India.
                  </p>
                  <div className="flex flex-wrap gap-2 justify-center mb-6">
                    <Badge
              ...
              <Card className="glass-card group hover:scale-105 transition-all duration-500 border-0 shadow-2xl overflow-hidden relative">
                ...
                <CardContent className="text-center relative z-10">
                  <p className="text-slate-600 mb-6 leading-relaxed">
                    Follow your favorite athletes, discuss matches, celebrate
                    victories, and be part of India's most passionate sports
                    community.
                  </p>
                  <div className="flex flex-wrap gap-2 justify-center mb-6">
                    <Badge
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-slate-600">
                  From grassroots to professional level across India
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="glass-card overflow-hidden group cursor-pointer">
                  <div className="relative">
                    <img
                      src="https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YmFkbWludG9ufGVufDB8fDB8fHww"
                      alt="Badminton"
                      className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-700"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
                ...
                <div className="glass-card overflow-hidden group cursor-pointer">
                  <div className="relative">
                    <img
                      src="https://plus.unsplash.com/premium_photo-1719318342626-77aa2788b830?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Z3Jhc3MlMjBob2NrZXl8ZW58MHx8MHx8fDA%3D"
                      alt="Hockey"
                      className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-700"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-slate-600">
                  Athletes discovered through our platform
                </p>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="text-center">
                      ...
                      <p className="text-slate-600 mb-4">
                        "Khel Bhoomi connected me with professional scouts. Now
                        I'm playing in the national league!"
                      </p>
                ...
                <Card className="glass-card border-0 shadow-xl">
                  <CardContent className="p-6">
                    <div className="text-center">
                      ...
                      <p className="text-slate-600 mb-4">
                        "The exposure I got here helped me get into the Olympic
                        training program. Dreams do come true!"
                      </p>
                      <div className="flex justify-center">
                        <Badge
                          variant="secondary"
                ...
                <Card className="glass-card border-0 shadow-xl">
                  <CardContent className="p-6">
                    <div className="text-center">
                      ...
                      <p className="text-slate-600 mb-4">
                        "From a small town to IPL trials - Khel Bhoomi made it
                        possible by connecting me with the right people!"
                      </p>
                      <div className="flex justify-center">
                        <Badge
                          variant="secondary"
            ...
            <div className="mb-16">
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold text-slate-800 mb-4">
                  Why Choose Khel Bhoomi?
                </h2>
                <p className="text-xl text-slate-600">
                  Everything you need to excel in sports
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Connect with scouts and get discovered by professional teams
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Join India's largest sports community and network
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Track your progress and showcase achievements
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Connect directly with athletes, scouts, and fans
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="col-span-1">
                ...
                <p className="text-slate-300 mb-6 leading-relaxed">
                  India's premier sports social platform connecting athletes,
                  scouts, and fans. Discover talent, celebrate achievements, and
            ...
            <div className="border-t border-slate-700 pt-8 mt-12">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div className="text-slate-400 text-sm mb-4 md:mb-0">
                  © 2025 Khel Bhoomi. All rights reserved. Empowering Indian
                  sports since 2025.
                </div>
            ...
            <div className="grid grid-cols-1 gap-2 text-xs">
              ...
              >
                ...
                <div className="text-right">
                  <div className="text-purple-600 font-mono hover:text-purple-700">
                    demo_athlete
                  </div>
                          ...
                          <div className="bg-slate-50 rounded-lg p-3">
                            <div className="flex items-center space-x-2 mb-1">
                              <span
                                ...
                                onClick={() =>
                                  navigate("/profile/sports_fan_123")
                                }
                              >
                                sports_fan_123
                              </span>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Upload an image and paste the URL here
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {popularSports
                    .filter(
                      (sport) => !formData.sports_interests.includes(sport)
                    )
                    .map((sport) => (
                      <Badge
                        key={sport}
        ...
        <CardContent className="p-6">
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-600 mb-4">
                {user?.bio ||
                  "Passionate athlete dedicated to excellence in sports"}
              </p>
        ...
        <CardContent className="p-6">
          <div className="flex items-start space-x-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-slate-600 mb-4">
                {user?.bio ||
                  "Professional scout discovering the next generation of sports talent"}
              </p>
              <div className="flex items-center space-x-4 text-sm text-slate-500">
                <div className="flex items-center space-x-1">
                  <MapPin className="h-4 w-4" />
